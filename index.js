...
window.onload = function() {
    ...
    //add event listener to each number in number conainer
        ...
        id("number-container").children[i].addEventListener("click", function() {
            ...
            if(!disableSelect) {
                ...
                if(this.classList.contains("selected")) {
                    ...
                    //select it and update selected variable
...
function startGame() {
    ...
    if(id("theme-1").checked) {
        ...
        qs("footer").classList.add("darkFooter");
    }
...
function generateBoard(board) {
    ...
    for(let i=0; i<81; i++) {
        ...
        //set tile text to correct number
            ...
            //add click event listeer to tile
...
function updateMove() {
    ...
    if(selectedTile && selectedNum) {
        //select the tile to the correct number
        console.log("update move called");
        if(selectedTile.textContent == selectedNum.textContent) {
            console.log(selectedTile.textContent +" = "+selectedNum.textContent);
            //if the number matches with the corresponding number in the solution key
...
//checking that entered answer is correct
function checkCorrect(tile) {
    ...
    console.log(solution.charAt(tile.id));
